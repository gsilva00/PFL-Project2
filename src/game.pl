...
move(game_state(Turn, Nest1-Nest2, Board, Scored1-Scored2, Player1Name-Player1Level, Player2Name-Player2Level), Turtle-(hatch-ColIdx), game_state(NewTurn, NewNest1-NewNest2, NewBoard, NewScored1-NewScored2, Player1Name-Player1Level, Player2Name-Player2Level)) :-
  ...
  % TODO REMOVE THIS valid_move(game_state(Turn, Nest1-Nest2, Board, Scored1-Scored2, Player1Name-Player1Level, Player2Name-Player2Level), Turtle-(hatch-ColIdx)),
...
move(game_state(Turn, Nest1-Nest2, Board, Scored1-Scored2, Player1Name-Player1Level, Player2Name-Player2Level), Turtle-Direction, game_state(NewTurn, NewNest1-NewNest2, NewBoard, NewScored1-NewScored2, Player1Name-Player1Level, Player2Name-Player2Level)) :-
  ...
  % TODO REMOVE THIS valid_move(game_state(Turn, Nest1-Nest2, Board, Scored1-Scored2, Player1Name-Player1Level, Player2Name-Player2Level), Turtle-Direction),
...
move_hatch(_, Turn, Nest1-Nest2, Board, Scored1-Scored2, RowIdx, ColIdx, TurtleStack, NewBoard, UpdatedNest1-UpdatedNest2, NewScored1-NewScored2) :-
  ...
  move_hatch(true, Turn, Nest1-Nest2, NewBoard, Scored1-Scored2, NewRowIdx, ColIdx, DisplacedTurtleStack, NewBoard, UpdatedNest1-UpdatedNest2, NewScored1-NewScored2).
...
%% Handle chain reactions from pushing turtles
%% Move TurtleStack off the board to the sides or to the end with the base turtle's own color - return turtles to the nests and stop chain reaction
%% Falling off the sides or the turtle's own end is allowed only for chain reactions from pushing turtles - they are the only moves that fail coordinates validation
...
move_normal(_, Turn, Nest1-Nest2, Board, Scored1-Scored2, RowIdx, ColIdx, Direction, TurtleStack, NewBoard, Nest1-Nest2, Scored1-Scored2) :-
  dest_coords(RowIdx, ColIdx, Direction, DestRowIdx, DestColIdx),
  cell_empty(Board, DestRowIdx, DestColIdx),
  move_empty(Board, RowIdx, ColIdx, DestRowIdx, DestColIdx, TurtleStack, NewBoard),
  !.
...
move_normal(_, Turn, Nest1-Nest2, Board, Scored1-Scored2, RowIdx, ColIdx, Direction, TurtleStack, NewBoard, Nest1-Nest2, Scored1-Scored2) :-
  dest_coords(RowIdx, ColIdx, Direction, DestRowIdx, DestColIdx),
  cell_can_climb(Board, DestRowIdx, DestColIdx, TurtleStack),
  move_climb(Board, RowIdx, ColIdx, DestRowIdx, DestColIdx, TurtleStack, NewBoard),
  !.
...
move_normal(_, Turn, Nest1-Nest2, Board, Scored1-Scored2, RowIdx, ColIdx, Direction, TurtleStack, NewBoard, NewNest1-NewNest2, NewScored1-NewScored2) :-
  dest_coords(RowIdx, ColIdx, Direction, DestRowIdx, DestColIdx),
  cell_can_push(Board, DestRowIdx, DestColIdx, TurtleStack),
  move_push(Board, RowIdx, ColIdx, DestRowIdx, DestColIdx, TurtleStack, NewBoard, DisplacedTurtleStack),
  !,
  ...
  move_normal(true, Turn, Nest1-Nest2, Board, Scored1-Scored2, DestRowIdx, DestColIdx, DisplacedTurtleStack, NewBoard, NewNest1-NewNest2, NewScored1-NewScored2).
%% Move TurtleStack to the normal cell (occupied cell - climb and push stack)
%% OR Move DisplacedTurtleStack because it is able to climb and push one of the turtles in the next turtle stack - continue chain reaction
move_normal(_, Turn, Nest1-Nest2, Board, Scored1-Scored2, RowIdx, ColIdx, Direction, TurtleStack, NewBoard, NewNest1-NewNest2, NewScored1-NewScored2) :-
  dest_coords(RowIdx, ColIdx, Direction, DestRowIdx, DestColIdx),
  cell_can_climb_push(Board, DestRowIdx, DestColIdx, TurtleStack),
  move_climb_push(Board, RowIdx, ColIdx, DestRowIdx, DestColIdx, TurtleStack, NewBoard, DisplacedTurtleStack),
  !,
  move_normal(true, Turn, Nest1-Nest2, Board, Scored1-Scored2, DestRowIdx, DestColIdx, DisplacedTurtleStack, NewBoard, NewNest1-NewNest2, NewScored1-NewScored2).
...
% move_outside_board(+OutsideMoveType, +EndColor, +TurtleStack, +(Nest1-Nest2), +(Scored1-Scored2), -(NewNest1-NewNest2), -(NewScored1-NewScored2))
%% Handle when a TurtleStack is moved outside the board (but not a scoring move)
%% - OutsideMoveType: sides - turtles are moved to the sides of the board (outside the board) and returned to the respective nests
move_outside_board(sides, _, Nest1-Nest2, _-_, [(Color-Number)|Rest], NewNest1-NewNest2, _-_) :-
...
move_outside_board(ends, EndColor, Nest1-Nest2, Scored1-Scored2, [(Color-Number)|Rest], NewNest1-NewNest2, NewScored1-NewScored2) :-
